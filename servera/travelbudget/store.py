...
def default_data():
    ...
    groups = [
        ...
        grp("TB-0003", "계획", C.ST_TRANSFER, "화성", "동진쎄미켐",
            ...
            [trav("이민호", "20120233", "팀장", "Photo 소재팀",
        ...
        grp("TB-0005", "계획", C.ST_INFORM, "공주", "솔브레인",
            ...
            [trav("이수진", "20180915", "팀장", "Chemical 소재팀",
        ...
        grp("TB-0006", "계획", C.ST_PLAN, "세종", "SK트리켐",
            ...
            [trav("최준영", "20170419", "팀장", "Precursor 소재팀",
                  [80000, 90000, 70000, 15000], Z)]),
        grp("TB-0007", "계획", C.ST_PLAN, "구미", "SK실트론",
            "Wafer 표면 결함 정기 Audit", K[2], dd(25), dd(26), "미사용",
            [trav("한지우", "20210302", "팀장", "Wafer 소재팀",
                  [120000, 100000, 70000, 20000], Z),
             trav("오세훈", "20160828", "팀장", "Target 소재팀",
                  [120000, 100000, 70000, 20000], Z)]),
