# 사내 Flask 서버 업로드 방법 (v10.26)

## 0. 준비물

- 패키지 `travelbudget_flask_v10.26.zip` (파일명 전부 영문 — 사내 압축 해제 문제 없음)
...
좌측 하단에 **v10.26 · 2026-08-06** 이 보이면 이 버전이 올라간 것입니다.
...
# 2. 5개 파일만 덮어쓰기
cp travelbudget_flask_v10.26/servera/travelbudget/core.py                       servera/travelbudget/
cp travelbudget_flask_v10.26/servera/travelbudget/routes.py                     servera/travelbudget/
cp travelbudget_flask_v10.26/servera/travelbudget/static/app.js                 servera/travelbudget/static/
cp travelbudget_flask_v10.26/servera/travelbudget/templates/index.html          servera/travelbudget/templates/
cp travelbudget_flask_v10.26/servera/travelbudget/templates/traveler_guide.html servera/travelbudget/templates/
...
(v10.26 에서 `store.py` 의 신규 설치용 기본값만 바뀌었고, 이미 원장이 있는 서버에서는 쓰이지 않습니다)
...
cp -r travelbudget_flask_v10.26/servera/travelbudget servera/
