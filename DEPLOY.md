# 사내 Flask 서버 업로드 방법 (v10.6)

## 0. 준비물

- 패키지 `travelbudget_flask_v10.6.zip` (파일명 전부 영문 — 사내 압축 해제 문제 없음)
...
좌측 하단에 **v10.6 · 2026-07-30** 이 보이면 이 버전이 올라간 것입니다.
...
# 2. 5개 파일만 덮어쓰기
cp travelbudget_flask_v10.6/servera/travelbudget/core.py                       servera/travelbudget/
cp travelbudget_flask_v10.6/servera/travelbudget/routes.py                     servera/travelbudget/
cp travelbudget_flask_v10.6/servera/travelbudget/static/app.js                 servera/travelbudget/static/
cp travelbudget_flask_v10.6/servera/travelbudget/templates/index.html          servera/travelbudget/templates/
cp travelbudget_flask_v10.6/servera/travelbudget/templates/traveler_guide.html servera/travelbudget/templates/
...
cp -r travelbudget_flask_v10.6/servera/travelbudget servera/
...
| 되돌리기 | v10.6가 새 필드를 쓰지 않으므로 이전 버전이 그대로 읽음 |
